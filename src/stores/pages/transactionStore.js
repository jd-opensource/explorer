...
const TransactionStore = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return fetchData(`${__HOST}/transaction/getRoleMenuTree`,
    ...
    getRoleManagementData(params) {
      return fetchData(`${__HOST}/transaction/getRoleManagementData`,
    ...
    searchRole(params) {
      return fetchData(`${__HOST}/transaction/searchRole`,
        self.setSearchRole,
        params, { method: 'get' })
        .catch((ex) => {
          Notification.error({
    ...
    saveRole(params) {
      return fetchData(`${__HOST}/transaction/saveRole`,
        self.setSaveRole,
        params, { method: 'post' })
        .catch((ex) => {
          Notification.error({
    ...
    saveRolePermission(params) {
      return fetchData(`${__HOST}/transaction/saveRolePermission`,
    ...
    deleteRole(params) {
      return fetchData(`${__HOST}/transaction/deleteRole`,
        self.setDeleteRole,
        params, { method: 'post' })
        .catch((ex) => {
          Notification.error({
